public class BusReservation implements Runnable{
	private int totalSeatsAvailable=1;
  ...
  public  synchronized boolean bookTickets(int seats, String name){
	  System.out.println("Bus Reservation System "+Thread.currentThread().getName()+" Number of Tickets Available are:"+this.getTotalSeatsAvailable());
